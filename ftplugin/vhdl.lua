...
vim.cmd('abb <buffer> var variable')
vim.cmd('abb <buffer> const constant')
vim.cmd('abb <buffer> sl std_logic')
vim.cmd('abb <buffer> slv std_logic_vector')
vim.cmd('abb <buffer> pro process')
vim.cmd('abb <buffer> func function')
vim.cmd('abb <buffer> ret return')
vim.cmd('abb <buffer> gen generate')
vim.cmd('abb <buffer> re rising_edge')
